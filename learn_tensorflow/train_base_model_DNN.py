...
import os, sys, pickle, pandas as pd, logging, shutil, tensorflow as tf
import myacct_env
...
if __name__ == '__main__':
    ...
    df = df[['userid', 'KEY', 'categoryid', 'category', 'startedon_order', 'PRODUCT_GROUP', 'PRODUCT_SEGMENT', 'CUST_REN_CD', 'TOTAL_BILL']].drop_duplicates()
    ...
    model_dir = myacct_env.WORKSPACE_DIR + '/myacct_training/DNN'
